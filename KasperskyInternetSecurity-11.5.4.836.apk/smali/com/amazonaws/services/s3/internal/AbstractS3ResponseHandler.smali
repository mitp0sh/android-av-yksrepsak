...
.method protected parseResponseMetadata(Lcom/amazonaws/http/HttpResponse;)Lcom/amazonaws/AmazonWebServiceResponse;
    ...
    const-string v5, "x-amz-request-id"
...
.method protected populateObjectMetadata(Lcom/amazonaws/http/HttpResponse;Lcom/amazonaws/services/s3/model/ObjectMetadata;)V
    ...
    invoke-virtual {p2, v6}, Lcom/amazonaws/services/s3/model/ObjectMetadata;->setExpirationTime(Ljava/util/Date;)V
    :try_end_2
    ...
    .line 132
    .local v4, "pe":Ljava/lang/NumberFormatException;
    sget-object v6, Lcom/amazonaws/services/s3/internal/AbstractS3ResponseHandler;->log:Lorg/apache/commons/logging/Log;
    ...
    const-string v7, "Unable to parse expiration time: "
    ...
    .line 134
    .end local v4    # "pe":Ljava/lang/NumberFormatException;
    :cond_5
    const-string v5, "x-amz-expiration"
    ...
    .line 137
    new-instance v5, Lcom/amazonaws/services/s3/internal/ObjectRestoreHeaderHandler;

    invoke-direct {v5}, Lcom/amazonaws/services/s3/internal/ObjectRestoreHeaderHandler;-><init>()V

    invoke-virtual {v5, p2, p1}, Lcom/amazonaws/services/s3/internal/ObjectRestoreHeaderHandler;->handle(Lcom/amazonaws/services/s3/internal/ObjectRestoreResult;Lcom/amazonaws/http/HttpResponse;)V
