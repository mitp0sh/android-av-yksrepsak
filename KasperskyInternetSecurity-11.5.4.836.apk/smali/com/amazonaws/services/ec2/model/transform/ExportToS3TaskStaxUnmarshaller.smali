...
.source "ExportToS3TaskStaxUnmarshaller.java"
...
.method public unmarshall(Lcom/amazonaws/transform/StaxUnmarshallerContext;)Lcom/amazonaws/services/ec2/model/ExportToS3Task;
    ...
    .prologue
    .line 36
    new-instance v0, Lcom/amazonaws/services/ec2/model/ExportToS3Task;

    invoke-direct {v0}, Lcom/amazonaws/services/ec2/model/ExportToS3Task;-><init>()V

    .line 37
    .local v0, "exportToS3Task":Lcom/amazonaws/services/ec2/model/ExportToS3Task;
    ...
    .line 49
    :cond_2
    const-string v4, "diskImageFormat"
    ...
    invoke-virtual {v0, v4}, Lcom/amazonaws/services/ec2/model/ExportToS3Task;->setDiskImageFormat(Ljava/lang/String;)V

    goto :goto_0

    .line 53
    :cond_3
    const-string v4, "containerFormat"
    ...
    invoke-virtual {v0, v4}, Lcom/amazonaws/services/ec2/model/ExportToS3Task;->setContainerFormat(Ljava/lang/String;)V

    goto :goto_0

    .line 57
    :cond_4
    const-string v4, "s3Bucket"
    ...
    invoke-virtual {v0, v4}, Lcom/amazonaws/services/ec2/model/ExportToS3Task;->setS3Bucket(Ljava/lang/String;)V

    goto :goto_0

    .line 61
    :cond_5
    const-string v4, "s3Key"
    ...
    invoke-virtual {v0, v4}, Lcom/amazonaws/services/ec2/model/ExportToS3Task;->setS3Key(Ljava/lang/String;)V
