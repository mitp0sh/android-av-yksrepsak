.class public Lcom/amazonaws/services/ec2/model/transform/DescribeVolumeStatusRequestMarshaller;
.super Ljava/lang/Object;
.source "DescribeVolumeStatusRequestMarshaller.java"
...
# virtual methods
.method public marshall(Lcom/amazonaws/services/ec2/model/DescribeVolumeStatusRequest;)Lcom/amazonaws/Request;
    .locals 16
    ...
    .line 40
    .local v7, "request":Lcom/amazonaws/Request;, "Lcom/amazonaws/Request<Lcom/amazonaws/services/ec2/model/DescribeVolumeStatusRequest;>;"
    const-string v14, "Action"

    const-string v15, "DescribeVolumeStatus"
    ...
    .line 44
    invoke-virtual/range {p1 .. p1}, Lcom/amazonaws/services/ec2/model/DescribeVolumeStatusRequest;->getVolumeIds()Ljava/util/List;

    move-result-object v11

    .line 45
    .local v11, "volumeIdsList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    const/4 v12, 0x1

    .line 47
    .local v12, "volumeIdsListIndex":I
    ...
    .line 48
    .local v13, "volumeIdsListValue":Ljava/lang/String;
    if-eqz v13, :cond_1
    ...
    .line 55
    .end local v13    # "volumeIdsListValue":Ljava/lang/String;
    :cond_2
    invoke-virtual/range {p1 .. p1}, Lcom/amazonaws/services/ec2/model/DescribeVolumeStatusRequest;->getFilters()Ljava/util/List;
    ...
    .line 66
    .local v8, "valuesList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    const/4 v9, 0x1

    .line 68
    .local v9, "valuesListIndex":I
    ...
    .line 69
    .local v10, "valuesListValue":Ljava/lang/String;
    if-eqz v10, :cond_4
    ...
    .end local v8    # "valuesList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .end local v9    # "valuesListIndex":I
    .end local v10    # "valuesListValue":Ljava/lang/String;
    :cond_5
    ...
    :cond_6
    invoke-virtual/range {p1 .. p1}, Lcom/amazonaws/services/ec2/model/DescribeVolumeStatusRequest;->getNextToken()Ljava/lang/String;
    ...
    .line 82
    :cond_7
    invoke-virtual/range {p1 .. p1}, Lcom/amazonaws/services/ec2/model/DescribeVolumeStatusRequest;->getMaxResults()Ljava/lang/Integer;
...
.method public bridge synthetic marshall(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/amazonaws/services/ec2/model/transform/DescribeVolumeStatusRequestMarshaller;->marshall(Lcom/amazonaws/services/ec2/model/DescribeVolumeStatusRequest;)Lcom/amazonaws/Request;
