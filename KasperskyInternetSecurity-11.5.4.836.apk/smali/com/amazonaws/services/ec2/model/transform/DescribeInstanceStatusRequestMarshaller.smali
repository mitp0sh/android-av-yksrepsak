.class public Lcom/amazonaws/services/ec2/model/transform/DescribeInstanceStatusRequestMarshaller;
.super Ljava/lang/Object;
.source "DescribeInstanceStatusRequestMarshaller.java"
...
# virtual methods
.method public marshall(Lcom/amazonaws/services/ec2/model/DescribeInstanceStatusRequest;)Lcom/amazonaws/Request;
    .locals 16
    ...
    .line 40
    .local v10, "request":Lcom/amazonaws/Request;, "Lcom/amazonaws/Request<Lcom/amazonaws/services/ec2/model/DescribeInstanceStatusRequest;>;"
    const-string v14, "Action"

    const-string v15, "DescribeInstanceStatus"
    ...
    .line 44
    invoke-virtual/range {p1 .. p1}, Lcom/amazonaws/services/ec2/model/DescribeInstanceStatusRequest;->getInstanceIds()Ljava/util/List;

    move-result-object v7

    .line 45
    .local v7, "instanceIdsList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    const/4 v8, 0x1

    .line 47
    .local v8, "instanceIdsListIndex":I
    ...
    .line 48
    .local v9, "instanceIdsListValue":Ljava/lang/String;
    if-eqz v9, :cond_1
    ...
    .line 55
    .end local v9    # "instanceIdsListValue":Ljava/lang/String;
    :cond_2
    invoke-virtual/range {p1 .. p1}, Lcom/amazonaws/services/ec2/model/DescribeInstanceStatusRequest;->getFilters()Ljava/util/List;
    ...
    :cond_6
    invoke-virtual/range {p1 .. p1}, Lcom/amazonaws/services/ec2/model/DescribeInstanceStatusRequest;->getNextToken()Ljava/lang/String;
    ...
    .line 82
    :cond_7
    invoke-virtual/range {p1 .. p1}, Lcom/amazonaws/services/ec2/model/DescribeInstanceStatusRequest;->getMaxResults()Ljava/lang/Integer;
    ...
    .line 85
    :cond_8
    invoke-virtual/range {p1 .. p1}, Lcom/amazonaws/services/ec2/model/DescribeInstanceStatusRequest;->isIncludeAllInstances()Ljava/lang/Boolean;
    ...
    .line 86
    const-string v14, "IncludeAllInstances"

    invoke-virtual/range {p1 .. p1}, Lcom/amazonaws/services/ec2/model/DescribeInstanceStatusRequest;->isIncludeAllInstances()Ljava/lang/Boolean;

    move-result-object v15

    invoke-static {v15}, Lcom/amazonaws/util/StringUtils;->fromBoolean(Ljava/lang/Boolean;)Ljava/lang/String;
...
.method public bridge synthetic marshall(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/amazonaws/services/ec2/model/transform/DescribeInstanceStatusRequestMarshaller;->marshall(Lcom/amazonaws/services/ec2/model/DescribeInstanceStatusRequest;)Lcom/amazonaws/Request;
